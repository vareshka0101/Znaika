    ...
    public function run()
    {
        ...
        $news = [
            ...
            [
                ...
                'content' => '<img src="/storage/images/news2.jpg" class="modal-news-image" alt="Безопасная среда"><div class="modal-news-meta"><span> 15 марта 2024</span><span> 189 просмотров</span></div><div class="modal-news-content"><h4>Что такое инклюзивная среда?</h4><p>Инклюзивная среда — это пространство, где каждый ребенок чувствует себя принятым и защищенным.</p><h4>Наши принципы безопасности</h4><ul><li>Физическая безопасность</li><li>Эмоциональная безопасность</li><li>Социальная инклюзия</li></ul></div>',
            ...
            [
                ...
                'content' => '<img src="/storage/images/news3.jpg" class="modal-news-image" alt="Здоровое питание"><div class="modal-news-meta"><span> 22 февраля 2024</span><span> 312 просмотров</span></div><div class="modal-news-content"><h4>Топ-5 полезных перекусов</h4><ol><li>Фруктовые шашлычки</li><li>Овощные палочки с хумусом</li><li>Домашние мюсли-батончики</li><li>Йогуртовые парфе</li><li>Смузи-боулы</li></ol></div>',
            ...
            [
                ...
                'content' => '<img src="/storage/images/news4.jpg" class="modal-news-image" alt="Творчество"><div class="modal-news-meta"><span> 26 марта 2024</span><span> 156 просмотров</span></div><div class="modal-news-content"><h4>Сезонные проекты</h4><ul><li>Осень: гербарий, поделки из листьев</li><li>Зима: снежинки, новогодние игрушки</li><li>Весна: цветы из бумаги</li><li>Лето: рисунки на асфальте</li></ul></div>',
        ...
        $reviews = [
            ...
            [
                ...
                'child_name' => 'Соня',
                'years_in_garden' => 'полгода в саду',
            ...
            [
                ...
                'child_name' => 'Артём',
                'years_in_garden' => '1,5 года в саду',
